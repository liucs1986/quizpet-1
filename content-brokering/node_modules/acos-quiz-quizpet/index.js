...
Annotated.register = function(handlers) {
    handlers.contentPackages['quizpet'] = Annotated;
    handlers.contentTypes.quiz.installedContentPackages.push(Annotated);
};

Annotated.namespace = 'quizpet';
...
conn2.query(queryString_java, function (error,rows,fields) {
    if (error) {
        ...
        for(var i = 0; i < data.length; i++) {
            ...
            quizpet[rdfid] = {}
            quizpet[rdfid].title = data[i].rdfid;
            quizpet[rdfid].description = 'This is an example';
            quizpet[rdfid].author = 'PAWS Lab';
            quizpet[rdfid].version = '0.1';
            quizpet[rdfid].created = '2015-11-15 00:00:00';
            quizpet[rdfid].modified = '2016-02-15 00:00:00';
            quizpet[rdfid].keywords = [title,'quizpet'];
            quizpet[rdfid].subitems = [];
            //quizpet[rdfid].subitems.push({"code":data[i].code,"comment":data[i].comment,"line":data[i].line});
        ...
        Annotated.meta = {
            ...
            'keywords': ['quizpet', 'java', 'questions'],
            'url': '',
            'teaserContent' : ['demo'],
            'contents2': {
                'demo': {
        ...
        Annotated.meta.quizpet = quizpet;
