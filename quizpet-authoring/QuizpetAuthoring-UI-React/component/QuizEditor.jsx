...
module.exports = React.createClass({
	...
	showValidation: function(event){
		event.preventDefault();
		if(this.state.quiz.questionTypeId == '2'){
			this.handleSubmit(event);
			return;
		}
		if(this.state.quiz.code.indexOf('result')<0){
			alert("The assesment type you select is 'final value', the value to be assessed must be called 'result'.");
			return;
		}

		    if (confirm("The assesment type you select is 'final value', please check if the value to be assessed is called 'result'.") == true) {
  ...
  <div className="modal-dialog modal-lg">
    <div className="modal-content">
      ...
      <div className="modal-body">
		<p style = {fsize}> (1) The code must have the parameter variable named '_Param', please see the following example:</p>
			<img   src="resources/images/p4.png" data-pin-nopin="true"/>
			<div><p style = {fsize}> (2) If the assesment type is 'final value', the final vaule to be assessed must be named as "result"</p></div>
			<img   src="resources/images/p2.png" data-pin-nopin="true"/>
...
<button type="button" className="btn btn-default" data-dismiss="modal">Cancel</button>
				...
				<h3 className="page-header">{pageHeaderMap[this.props.goal]}</h3>
				<form className="form-horizontal">
					...
					<div className="form-group">
						<div className="col-sm-offset-2 col-sm-10">
							...
							className="btn btn-primary" onClick={this.showValidation}>Submit</button>
						</div>
					</div>
				</form>
			</div>
